...
public class ConstantController {
    ...
    public static final int UI_SCREEN_WIDTH;

    public static final int UI_SCREEN_HEIGHT;
    ...
    static {
        ...
        int height = 800;
        try {
            width = (int) (Toolkit.getDefaultToolkit().getScreenSize().width * 0.65);
        ...
        SCREEN_SIZE = new Dimension(UI_SCREEN_WIDTH, UI_SCREEN_HEIGHT);
    }
